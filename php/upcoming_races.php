...
$resource_0 = $link->query("SELECT * FROM race_schedule WHERE (round > '$last_race_round') and (is_done = false) ORDER BY round ASC");
        ...
        <div class="row">
            ...
            <div class="col-md-9">
                ...
                <div style="text-align:center; vertical-align:middle;">
                    <img src="../bootstrap/assets/img/races/<?php echo $races[0][1]?>.png" style="width:512px;height:288px; margin:auto;">
